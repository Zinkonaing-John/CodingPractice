...
function Portfolio() {
  ...
  return (
    <div className="mt-5 flex justify-center flex-col">
      <div className="flex flex-row px-6 md:px-0 justify-center items-center">
        <h1 className="text-black text-[40px] font-bold text-center">
          My Creative <span className="text-purple-700">Portfolio</span>
        </h1>
      ...
      <div className="flex flex-row justify-evenly gap-2 px-4 md:px-72">
        <button
          ...
          className="border-purple-600 border-2 text-purple-600  focus:text-white
