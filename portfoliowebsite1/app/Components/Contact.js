  ...
  return (
    <div className="flex flex-col justify-center mt-5">
      <div className="flex flex-row justify-center">
        <h1 className="text-black text-[50px] items-center justify-center text-center">
          Contact <span className="text-purple-600">Us</span>
        </h1>
        <Image src={phone} className="w-[80px] ml-4 " />
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 justify-evenly px-10 md:px-44">
        <Image src={contactusbg} className="w-[300px] mr-10 " />
        <div className="w-full">
          <div className="flex flex-col ">
            <label className="text-gray-400 ">Email</label>
            <input
              type="text"
              placeholder="yourname@gmal.com "
          ...
          <button
            className="transition-all ease-in-out hover:scale-110
             bg-purple-500 flex flex-row items-center justify-center text-[14px]
              py-1 mt-5 text-white  rounded-md w-full"
          >
            Submit
            <svg
